...
var PAGE_URLS = {
    GET_PAGE_BY_GOODS_ATTRIBUTE_ID: contextPath + "/goodsAttribute/getPage",
    SAVE_OR_UPDATE: contextPath + "/goodsAttribute/saveOrUpdate",
    DELETE_ATTR: contextPath + "/goodsGroup/deleteGoodsAttribute",
    DELETE_OPTION: contextPath + "/goodsGroup/deleteAttributeOption"
};
...
var initPageDom = function (params) {
    ...
    if (params.callParams.id) {
        $('#goods-group-id').val(params.callParams.id);
    }
...
var saveOrUpdate = function () {
    ...
    var params = {
        'goodsGroupId': $('#goods-group-id').val()
    };
...
var initFormData = function (params) {
    ...
    if (params.callParams.id) {
        ...
        var p = {
            goodsGroupId: params.callParams.id
        };
