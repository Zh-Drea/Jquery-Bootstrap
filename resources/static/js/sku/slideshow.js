var PAGE_URLS = {
    SAVE_OR_UPDATE_DETAILS: contextPath + "/sku/saveDetailImagesOrSliderImages",
    GET_BY_ID: contextPath + "/sku/getDetailImagesOrSliderImageBySkuId",
    DELETE: contextPath + "/sku/deleteDetailImagesOrSliderImage"
};
...
var saveOrUpdate = function (obj) {
    ...
    if (obj.callParams.id) {
        ...
        params.skuId = obj.callParams.id;

        params.attachmentType = 'SLIDER';
        ...
        for (var i = 1; i < index; i++) {
            ...
            if (imageTemple) {
                ...
                plt.attachmentType = 'SLIDER';

                imageAttachments.push(plt);
            }
        }

        params.skuRefAttachments = imageAttachments;
