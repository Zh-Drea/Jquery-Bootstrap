...
var initFormData = function (params) {
    ...
    if (params.callParams.logisticId) {

        var p = {
            id: params.callParams.logisticId
        };
