...
var PAGE_URLS = {
    ...
    GET_PAGE: contextPath + '/columnGroupItem/getPage',

    DELETE: contextPath + '/columnGroupItem/delete',

    GET_ALL_COLUMN_GROUP: contextPath + "/columnGroup/getAll",

    SAVE_OR_UPDATE: contextPath + "/columnGroupItemRefSpu/saveColumnGroupItemRefSpu"
};
...
var toolbarListener = function () {
    ...
    if (length === 1) {
        ...
        spuQueryParams.columnGroupItemId = rows[0].id;
...
var selectRowsCallback = function (params) {
    ...
    res.columnGroupItemId = $(PAGE_DOMS.PAGE_DATA_TABLE).bootstrapTableGetSelectionRow().id;
    ...
    $('#toolbar button').click(function () {
        ...
        if ('ref-spu'=== optHandle) {
            $.extend(callParams, {
                ...
                columnGroupItemId: $(PAGE_DOMS.PAGE_DATA_TABLE).bootstrapTableGetSelectionRow().id
            })
        }
        ...
        new Message().openView({
            content: [contextPath + '/columnGroupItem/editPage', 'no'],
            title: title,
            area: ['800px', '423px']
